...
public class HuaweiAiGalleryIamOptions {
    ...
    public static class Builder {
        ...
        private final HuaweiAiGalleryIamOptions options = new HuaweiAiGalleryIamOptions();
        ...
        public HuaweiAiGalleryIamOptions build() {
            return this.options;
        }
