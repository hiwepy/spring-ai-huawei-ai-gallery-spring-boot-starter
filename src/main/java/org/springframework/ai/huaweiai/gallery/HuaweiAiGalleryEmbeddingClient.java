...
public class HuaweiAiGalleryEmbeddingClient extends AbstractEmbeddingClient {
    ...
    public HuaweiAiGalleryEmbeddingClient(LLM llm) {
        this(llm, MetadataMode.EMBED);
    }

    public HuaweiAiGalleryEmbeddingClient(LLM llm, MetadataMode metadataMode) {
        this(llm, metadataMode, HuaweiAiGalleryEmbeddingOptions.builder().build());
    }

    public HuaweiAiGalleryEmbeddingClient(LLM llm, MetadataMode metadataMode, HuaweiAiGalleryEmbeddingOptions options) {
