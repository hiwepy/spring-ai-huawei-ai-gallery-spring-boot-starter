...
public class HuaweiAiGalleryModuleOptions {
    ...
    public static class Builder {
        ...
        private final HuaweiAiGalleryModuleOptions options = new HuaweiAiGalleryModuleOptions();
        ...
        public HuaweiAiGalleryModuleOptions build() {
            return this.options;
        }
