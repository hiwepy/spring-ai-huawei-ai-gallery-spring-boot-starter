...
public class HuaweiAiGalleryHttpProxyOptions {
    ...
    public static class Builder {
        ...
        private final HuaweiAiGalleryHttpProxyOptions options = new HuaweiAiGalleryHttpProxyOptions();
        ...
        public HuaweiAiGalleryHttpProxyOptions build() {
            return this.options;
        }
